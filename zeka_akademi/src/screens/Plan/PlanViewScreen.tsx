  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        >
          <MaterialCommunityIcons name="chart-pie" size={22} color="#1a237e" />
        </TouchableOpacity>
      </View>
      {/* Üst araç çubuğu */}
      <View style={styles.toolbar}>
        ...
        >
          <MaterialCommunityIcons name="chevron-left" size={28} color="#1a237e" />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          onPress={() => setWeekOffset(weekOffset + 1)}
        >
          <MaterialCommunityIcons name="chevron-right" size={28} color="#1a237e" />
        </TouchableOpacity>
      </View>
            ...
            <View key={day} style={styles.dayColumn}>
              ...
              {tasksByDay[i].map((task) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.taskCard,
                    { borderLeftColor: SUBJECT_COLORS[task.subject] || '#7c4dff' },
                  ]}
                >
...
const styles = StyleSheet.create({
  ...
  toggleTextActive: { color: '#1a237e', fontWeight: '600' },
  scroll: { flex: 1 },
  scrollContent: {
    flexDirection: 'row',
    padding: 16,
